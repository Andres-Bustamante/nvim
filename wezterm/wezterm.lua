...
-- config.color_scheme = "Eldrich"
-- config.color_scheme = "Everforest Dark (Gogh)"
config.color_scheme = "Oldword"
...
config.font = wezterm.font_with_fallback({
	"IosevkaTerm NF", -- tu fuente principal
	"CustomIcons_with_kuromi", -- tu fuente personalizada con el glifo en U+EEEEE
})
